  ...
  return (
    ...
    <div className="a-right">
      <form className="infoForm authForm" onSubmit={handleSubmit}>
        ...
        <span style={{display:confirmpass?"none":"block",color:"red",fontSize:"13px",alignSelf:"end",marginRight:"5px"}}>
          * password didn't match !
        </span>
        <div>
            <span style={{fontSize:'13px',cursor:"pointer"}} onClick={()=>{setIsSignup((prev)=>!prev);resetForm()}} >{isSignup?"Already have an account?. Login":"Dont have an account?. Signup here..!"}</span>
        </div>
